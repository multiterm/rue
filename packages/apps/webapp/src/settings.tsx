...
export function SettingsPanel({ owner, general, onClose }: { owner: string; general: ReactNode; onClose(): void }) {
  ...
  return <Dialog open onClose={onClose} title="Settings" description="Personalize your workspace and manage your agent preferences." className="rue-settings-dialog">
    <div className="rue-settings-layout">
      ...
      <div className="rue-settings-page-frame">
