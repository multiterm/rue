...
const styles=StyleSheet.create({root:{flex:1,justifyContent:'space-between',padding:32,backgroundColor:'#09120e'},mark:{color:'#8df0b2',fontWeight:'800',letterSpacing:5,marginTop:40},title:{color:'#fff',fontSize:56,fontWeight:'800',lineHeight:58,marginTop:80},copy:{color:'#9bb1a1',fontSize:18,lineHeight:27,marginTop:20},button:{backgroundColor:'#8df0b2',padding:18,borderRadius:14,alignItems:'center',marginBottom:24},buttonText:{color:'#07100b',fontWeight:'800',fontSize:16}})
