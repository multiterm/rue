...
- `rune review-development` / `rune review-preview`: explicit live readiness reports, including blocked authenticated prerequisites. See [feature readiness](../docs/feature-readiness.md). These are deliberately not aliases for passing browser smoke tests.
