...
Open **Agent settings** using the sidebar gear or the conversation's workspace menu. Settings belong to the signed-in Keyname subject, not the server administrator or another user.
