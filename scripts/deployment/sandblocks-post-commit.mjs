...
const child=spawn(sandblocks,['sandbox',command,root,'--environment',environment],{cwd:root,detached:true,stdio:['ignore',log.fd,log.fd],env:{...process.env,SANDBLOCKS_SKIP_POST_COMMIT:'1',SANDBLOCKS_RETAIN_FAILED:'true'}})
